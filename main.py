...
async def parse_poker_pdf(req: ParseRequest):
    ...
    for ref in refs:
        ...
        try:
            pages = min(doc.page_count, max_pages_to_scan)
            timeline = []
            ...
            # Build hand windows with gap rule
            hands = []
            current = None
            last_page = None
            hand_index = 0
